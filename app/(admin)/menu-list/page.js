          ...
          {menuList &&
            menuList.map((item) => (
              <div
                ...
                className="rounded-lg text-center hover:-translate-y-3 transition-transform duration-300 overflow-hidden ring-1 ring-emerald-500 shadow-lg shadow-slate-200 bg-lime-50"
              >
                <div className="w-full h-full flex flex-col justify-around p-8">
                  <SingleMenu {...item} />
