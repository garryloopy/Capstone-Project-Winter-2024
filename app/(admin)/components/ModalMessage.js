export default function ModalMessage({
  ...
  return (
    <section
      ...
      className="fixed inset-0 grid place-items-center data-[visible=true]:opacity-100 data-[visible=true]:pointer-events-auto opacity-0 pointer-events-none z-40 backdrop-brightness-90 transition-opacity duration-300"
    >
