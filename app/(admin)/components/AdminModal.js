    ...
    <>
      {showModal && (
        <div className="fixed bottom-0 right-[.1rem] lg:mr-4 lg:mb-4 text-white">
          <div className="bg-black/60 p-4 rounded-md shadow-md border flex flex-col ">
            <span
            ...
            <div className="p-4 flex flex-col justify-center items-center">
              ...
              <Link
                className="px-4 py-2 border border-gray-400 rounded-md my-6 hover:bg-white hover:text-black"
                href="/sign-in"
              >
                Sign in
              </Link>
